            ...
            <div class="col-lg-3">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">Orders</h6> <span><%=totalQuantity%></span>
            ...
            <div class="col-lg-3">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">Cancelled</h6> <span><%=totalCancelled%></span>
                        </div>
                    </article>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            <h6 class="mb-1 card-title">Shipped</h6> <span><%=totalShipped%></span>
